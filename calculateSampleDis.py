...
def parse_option():
    ...
    parser.add_argument('--model_path', type=str, default=None, help='path to save linear classifier')
    parser.add_argument('--result_path', type=str, default=None, help='path to save linear classifier')
